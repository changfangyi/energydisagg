...
def build_model(input_shape, appliances):
    ...
    # conv
    conv_1 = Conv1D(filters=MODEL_CONV_FILTERS,
                     kernel_size=MODEL_CONV_KERNEL_SIZE,
                     strides=MODEL_CONV_STRIDES,
                     padding=MODEL_CONV_PADDING, activation='linear')(x)
    # reshape
    conv_1 = Flatten()(conv_1 )
    # dense
    dense_1 = Dense(units=seq_length*MODEL_CONV_FILTERS, activation='linear')(conv_1 )
