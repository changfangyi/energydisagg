...
def build_model(input_shape, appliances):
    ...
    dense_3 = Dense(units=64, activation='linear')(dense_2)
    dense_4 = Dense(units=seq_length*2, activation='relu')(dense_3)
    dense_4 = Reshape(target_shape=(seq_length, 2))(dense_4)
    # Initialization
